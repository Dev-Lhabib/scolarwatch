...
return [
    ...
    'description' => 'API de gestion scolaire de ScolarWatch : authentification, utilisateurs, élèves, classes, matières, notes, absences, retards, remarques, notifications et synthèses IA.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            ScolarWatch centralise la vie scolaire d'un établissement : gestion des utilisateurs (rôles `admin`, `direction`, `enseignant`, `parent`), des élèves, des classes et des matières, ainsi que le suivi des notes, absences, retards et remarques.
    ...
    'auth' => [
        ...
        'extra_info' => 'Tous les endpoints (sauf <code>POST /api/login</code> et <code>GET /api/health</code>) exigent un jeton Sanctum. Obtenez-le en appelant <code>POST /api/login</code> puis transmettez-le dans l\'en-tête <code>Authorization: Bearer &lt;token&gt;</code>.',
    ],
