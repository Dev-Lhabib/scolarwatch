...
Route::inertia('/dashboard/enseignant/classes', 'dashboard/enseignant/classes')->name('dashboard.enseignant.classes');
Route::inertia('/dashboard/enseignant/saisie', 'dashboard/enseignant/saisie')->name('dashboard.enseignant.saisie');
...
Route::inertia('/admin/users/archives', 'admin/users/archives')->name('admin.users.archives');
