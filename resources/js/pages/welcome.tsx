...
export default function Welcome() {
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center bg-slate-50 p-6 text-slate-900 lg:justify-center lg:p-8 dark:bg-slate-950">
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] border border-slate-200 lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100">
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-slate-200 dark:before:border-slate-800">
                                    <span className="relative bg-white py-1 dark:bg-slate-900">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-slate-200 bg-slate-50 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-slate-800 dark:bg-slate-900">
                                    ...
                                    <span>
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-indigo-600 underline underline-offset-4 dark:text-indigo-400"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-slate-200 dark:before:border-slate-800">
                                    <span className="relative bg-white py-1 dark:bg-slate-900">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-slate-200 bg-slate-50 shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-slate-800 dark:bg-slate-900">
                                            <span className="h-1.5 w-1.5 rounded-full bg-slate-300 dark:bg-slate-700" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-indigo-600 bg-indigo-600 px-5 py-1.5 text-sm leading-normal text-white hover:border-indigo-700 hover:bg-indigo-700 dark:border-indigo-500 dark:bg-indigo-500 dark:text-white dark:hover:border-indigo-400 dark:hover:bg-indigo-400"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            <div className="absolute inset-0 rounded-t-lg border border-slate-200 lg:rounded-t-none lg:rounded-r-lg dark:border-slate-800"></div>
                        </div>
                    </main>
                </div>
            </div>
